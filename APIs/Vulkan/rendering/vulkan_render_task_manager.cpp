...
namespace wilo{
    ...
    : wilo::RenderTaskManager(contextRef,swapchainRef,frameBufferArrayRef),
    ...
    void VulkanRenderTaskManager::SetRenderPass(wilo::SharedPointer<wilo::RenderPass> renderPassRef){
        wilo::SharedPointer<VulkanRenderPass> vulkanRenderPassRef = std::static_pointer_cast<VulkanRenderPass>(renderPassRef);
        m_renderPass = vulkanRenderPassRef->get();
    } 
    void VulkanRenderTaskManager::CreateDrawTask(wilo::SharedPointer<wilo::GraphicsPipeline> pipelineRef){
        ...
        wilo::SharedPointer<VulkanGraphicsPipeline>  vkPipelineRef = std::static_pointer_cast<VulkanGraphicsPipeline>(pipelineRef);
        ...
        VkClearValue clearColor = {0.0,0.0,0.0,1.0};//make the clear color RED
