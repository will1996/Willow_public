...
#define WILO_CORE_INFO(...) ::wilo::logr::getCoreLogger()->info(__VA_ARGS__);
#define WILO_CORE_WARNING(...) ::wilo::logr::getCoreLogger()->warn(__VA_ARGS__)
#define WILO_CORE_ERROR(...) ::wilo::logr::getCoreLogger()->error(__VA_ARGS__);
#define WILO_CORE_CRITICAL(...) ::wilo::logr::getCoreLogger()->critical(__VA_ARGS__);
//app_level logging functions
#define WILO_INFO(...) ::wilo::logr::getAppLogger()->info(__VA_ARGS__);
